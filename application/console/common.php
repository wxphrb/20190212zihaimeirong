...

{
	...
	$page1  = Request::instance()->param("page");
	$name1  = Request::instance()->param("name");
	$pagen  = isset($page1) ? Request::instance()->param("page") :1;
	$name   = isset($name1) ? urlencode(Request::instance()->param("name")) :'';
	
	if(empty($name)){
		$url = Url::build($module . '/' . $controller . '/renewfield',['page'=>$pagen]);
	}else{
		$url = Url::build($module . '/' . $controller . '/renewfield',['page'=>$pagen,'name'=>$name]);
	}
    ...
    if ($operate == 'delete') {
		...
		$page1  = Request::instance()->param("page");
		$pagen  = isset($page1) ? Request::instance()->param("page") :1;
		$url = Url::build($module . '/' . $controller . '/'.$operate,['page'=>$pagen,'name'=>$name]);
        if ($id == 0) {
        ...
        if ($id == 0) {
            ...
            $ret = '<a class="label label-danger" onClick="check_state(\'' . $url . '\',\'' . $id . '\');"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;' . $describe . '</a>';

        } else {

            $ret = '<a style="text-decoration:none;" class="text text-danger"  onClick="check_state(\'' . $url . '\',\'' . $id . '\');"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;' . $describe . '</a>';

        }
	} else {

        $url = Url::build($module . '/' . $controller . '/' . $operate, ['id' => $id ,'page'=>$pagen,'name'=>$name]);
...
function show_recommend($status, $id, $field = 'id', $controller = '')

{
    ...
    switch ($status) {
        ...
        case 0 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'recommend\',\'1\');"><i class = "glyphicon glyphicon-remove-sign text-danger"></i></a>';
        ...
        case 1 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'recommend\',\'0\');"><i class = "glyphicon glyphicon-ok-sign text-success"></i></a>';
        ...
        case 2 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'recommend\',\'2\');"><i class = "glyphicon glyphicon-remove-sign text-danger"></i></a>';
...

{
    ...
    switch ($status) {
        ...
        case 2 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status\',\'2\');"><i class = "glyphicon glyphicon-remove-sign text-danger"></i></a>';
...
function show_status_buy($status, $id, $field = 'id', $controller = '')

{
    ...
    switch ($status) {
        ...
        case 0 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status_buy\',\'1\');"><i class = "glyphicon glyphicon-remove-sign text-danger"></i></a>';
        ...
        case 1 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status_buy\',\'0\');"><i class = "glyphicon glyphicon-ok-sign text-success"></i></a>';
        ...
        case 2 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'show_status_buy\',\'2\');"><i class = "glyphicon glyphicon-remove-sign text-danger"></i></a>';
...
/*售卖状态 0无 1已订车 2贷款中 3已售出 */
function show_buy_status($status, $id, $field = 'id', $controller = '')

{
    ...
    switch ($status) {
        ...
        case 0 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status_buy\',\'1\');">无</a>';
        ...
        case 1 :
            ...
            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status_buy\',\'2\');">已订车</a>';

            break;

        case 2 :

            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status_buy\',\'3\');">贷款中</a>';

            break;
        case 3 :

            $ret = '<a onClick="check_state(\'' . $url . '\',\'' . $id . '\',\'status_buy\',\'0\');">已售出</a>';
