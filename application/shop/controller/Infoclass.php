...
use think\Request;
use think\Url;
use app\shop\model\Infoclass as ThisModel;
...
class Infoclass extends Base
{
	...
	public function create()
	{
		if (Request::instance()->isPOST())
		{
			...
			if (true === $result) {
                $this->success('新建成功', 'shop/Infoclass/index');
            } else {
                $this->error($result);
            }
		}
	...
	public function update($id)
	{
		if (Request::instance()->isPOST())
		{
			...
			if (true === $result) {
                $this->success('更新成功', 'shop/Infoclass/index');
            } else {
                $this->error($result);
            }
		}
	...
	public function delete(){
		if (Request::instance()->isPOST())
		{
			...
			if($delmodel){
			    $this->success('删除成功', 'shop/Infoclass/index');
			}
			else{
