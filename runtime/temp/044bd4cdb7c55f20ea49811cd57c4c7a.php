            ...
            <table class="table table-striped table-bordered table-hover" id="table1">
                ...
                <tr>
                    ...
                    <td style="color: #428bca">
                        <?php switch($vo['status']): case "0": ?><i class="fa fa-taxi" onclick="sq('<?php echo $vo['id']; ?>')" >&nbsp;确认收到货款</i><?php break; case "1": ?><i class="fa fa-taxi" onclick="fahuo('<?php echo $vo['id']; ?>')" >&nbsp;代发货</i><?php break; ?>
                        {/case}
                        <?php case "2": ?>待收货<?php break; case "3": ?>待评价<?php break; case "4": ?>已完成<?php break; case "5": ?><i class="fa fa-thumbs-up" style="cursor: pointer" onclick="ttk('<?php echo $vo['id']; ?>')">同意退款</i>&nbsp;&nbsp;&nbsp;&nbsp;<i
...
<script>
    function fahuo(id) {
        ...
        $(".tj").click(function () {
            ...
            $.post(
                "<?php echo url('Deliver/fahuo'); ?>",{id:id,courier_name:name,courier_number:member},function (data) {
                    layer.msg(data.msg);
                    setTimeout(function () {
                        location.reload();
                    },1500)
    ...
    function sq(id) {
        $.post(
            "<?php echo url('Online/reject_tk'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
    ...
    function ju_tk(id) {
        $.post(
            "<?php echo url('Deliver/reject_tk'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
    ...
    function ju_th(id) {
        $.post(
            "<?php echo url('Deliver/reject_th'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_15543__=1;$__FOR_END_15543__=9;for($i=$__FOR_START_15543__;$i < $__FOR_END_15543__;$i+=1){ ?>
