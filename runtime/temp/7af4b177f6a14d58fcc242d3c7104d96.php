...
<script>
    function fahuo(id) {
        ...
        $(".tj").click(function () {
            ...
            $.post(
                "<?php echo url('Orders/fahuo'); ?>",{id:id,courier_name:name,courier_number:member},function (data) {
                    layer.msg(data.msg);
                    setTimeout(function () {
                        location.reload();
                    },1500)
    ...
    function ttk(id) {
        $.post(
            "<?php echo url('Orders/achieve'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
    ...
    function ju_tk(id) {
        $.post(
            "<?php echo url('Orders/reject_tk'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
    ...
    function ju_th(id) {
        $.post(
            "<?php echo url('Orders/reject_th'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_17434__=1;$__FOR_END_17434__=9;for($i=$__FOR_START_17434__;$i < $__FOR_END_17434__;$i+=1){ ?>
