<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\store\index.html";i:1554281749;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\create.html";i:1554692404;s:90:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\sidebar.html";i:1540438922;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\topbar.html";i:1540438923;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\footer.html";i:1554692403;}*/ ?>
<!DOCTYPE html>
...
<div class="panel panel-default">
    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <form class="form-horizontal form-bordered" id="submitForm" action="update" method="post">
            <div class="form-group">
                <label class="col-sm-3 control-label">店铺名称:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="title" placeholder="店铺名称" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>">
                </div>
            </div>
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-6">-->
                    ...
                    <!--<input type="hidden" id="picurl" placeholder="logo" name="picurl" value="<?php echo isset($vo['picurl']) ? $vo['picurl'] :  ''; ?>">-->
                <!--</div>-->
            <!--</div>-->
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-6">-->
                    <!--<input id="filetwo" type="file" class="file-loading">-->
                    <!--<input type="hidden" id="picurls" placeholder="封面图" name="pic" value="<?php echo isset($vo['pic']) ? $vo['pic'] :  ''; ?>">-->
                <!--</div>-->
            <!--</div>-->
			<!--<div class="form-group">-->
                <!--<label class="col-sm-3 control-label">电脑端-封面图：</label>-->
                <!--<div class="col-sm-6">-->
                    <!--<input id="filetwo_pc" type="file" class="file-loading">-->
                    <!--<input type="hidden" id="picurls_pc" placeholder="电脑端-封面图" name="pic_pc" value="<?php echo isset($vo['pic_pc']) ? $vo['pic_pc'] :  ''; ?>">-->
                <!--</div>-->
            <!--</div>-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="password" placeholder="不改勿填" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">确认密码:</label>
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="repassword" placeholder="请输入确认密码" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label"><span>*</span>掌柜的：</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="掌柜的" name="manned" value="<?php echo isset($vo['manned']) ? $vo['manned'] :  ''; ?>"
                           required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="手机号" name="mobile" value="<?php echo isset($vo['mobile']) ? $vo['mobile'] :  ''; ?>"
                           required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="手机号" name="qq" value="<?php echo isset($vo['qq']) ? $vo['qq'] :  ''; ?>"
                           required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="pro" placeholder="所在城市" datatype="*"
                           value="<?php echo isset($vo['pro']) ? $vo['pro'] :  ''; ?>" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="address" placeholder="收货地址" datatype="*"
                           value="<?php echo isset($vo['address']) ? $vo['address'] :  ''; ?>" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">收货人姓名：</label>
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="consignee" placeholder="收货人姓名" datatype="*"
                           value="<?php echo isset($vo['consignee']) ? $vo['consignee'] :  ''; ?>" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">收货电话：</label>
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="consignee_mobile" placeholder="收货电话" datatype="*"
                           value="<?php echo isset($vo['consignee_mobile']) ? $vo['consignee_mobile'] :  ''; ?>" >
                </div>
            </div>			<div class="form-group">                <label class="col-sm-3 control-label">店铺介绍：</label>                <div class="col-sm-6">						    <textarea class="form-control" placeholder="" name="description"                              id="container"><?php echo isset($vo['description']) ? $vo['description'] :  ''; ?></textarea>                </div>            </div>
            <div class="form-group">
    ...
    <script src="__CONSOLE__/js/descates.js"></script>
       ...
       <script>
        $(document).ready(function () {
            $("[name='status'][value='<?php echo isset($vo['status']) ? $vo['status'] :  '1'; ?>']").attr("checked", true);                            fileinputOne("fileone", "picurl");
            ...
            });            //select2            jQuery(".select2").select2({                width: '100%',                minimumResultsForSearch: -1            });
            ...
            $("[name='type_id']").find("[value='<?php echo isset($type_id) ? $type_id :  ''; ?>']").attr("selected", true);
            fileinputOne("filetwo", "picurls");
            fileinputOne("filetwo_pc", "picurls_pc");
            var ue = UE.getEditor("container", {initialFrameWidth: null});
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_9047__=1;$__FOR_END_9047__=9;for($i=$__FOR_START_9047__;$i < $__FOR_END_9047__;$i+=1){ ?>
