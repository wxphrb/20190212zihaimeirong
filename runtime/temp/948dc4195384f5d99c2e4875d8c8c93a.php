...
<script>
    function fahuo(id) {
        ...
        $(".tj").click(function () {
            ...
            $.post(
                "<?php echo url('Other/fahuo'); ?>",{id:id,courier_name:name,courier_number:member},function (data) {
                    layer.msg(data.msg);
                    setTimeout(function () {
                        location.reload();
                    },1500)
    ...
    function ttk(id) {
        $.post(
            "<?php echo url('Other/achieve'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
    ...
    function ju_tk(id) {
        $.post(
            "<?php echo url('Other/reject_tk'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
    ...
    function ju_th(id) {
        $.post(
            "<?php echo url('Other/reject_th'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_8016__=1;$__FOR_END_8016__=9;for($i=$__FOR_START_8016__;$i < $__FOR_END_8016__;$i+=1){ ?>
