            ...
            <table class="table table-striped table-bordered table-hover" id="table1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="<?php echo url('evaluate/index',['goods_id'=>$vo['id']]); ?>">查看评价</a>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_5192__=1;$__FOR_END_5192__=9;for($i=$__FOR_START_5192__;$i < $__FOR_END_5192__;$i+=1){ ?>
