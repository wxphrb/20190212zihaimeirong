    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <form class="form-horizontal form-bordered" id="submitForm" action="" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="标题" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>"
                           required>
                </div>
            </div>			<div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>描述：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="描述" name="description" value="<?php echo isset($vo['description']) ? $vo['description'] :  ''; ?>"
                       required>
            </div>
        </div>
...
<script type="text/javascript" charset="utf-8" src="__PLUGIN__/ueditor/lang/zh-cn/zh-cn.js"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("[name='picarr_type'][value='<?php echo isset($vo['picarr_type']) ? $vo['picarr_type'] :  '3'; ?>']").attr("checked", true);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_14761__=1;$__FOR_END_14761__=9;for($i=$__FOR_START_14761__;$i < $__FOR_END_14761__;$i+=1){ ?>
