<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\.\login.html";i:1540438894;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
...
<body>
                      ...
                      <div class="form-top">
                       ...
                       <form role="form" action="" method="post" class="login-form">
                        <div class="form-group">
                          <label class="sr-only" for="form-mobile">用户名</label>
                            <input type="text" name="mobile" placeholder="用户名..." class="form-mobile form-control" value="">
                          </div>
                          <div class="form-group">
                            <label class="sr-only" for="form-password">密码</label>
                            <input type="password" name="password" placeholder="密码..." class="form-password form-control" value="">
                          </div>
    ...
    <script type="text/javascript">
                    function sx(val)
                    {
                        var urll="<?php echo url('shop/login/get_captcha'); ?>";
                        val.src=urll;
                    }
                  </script>
    <!--[if lt IE 10]>
