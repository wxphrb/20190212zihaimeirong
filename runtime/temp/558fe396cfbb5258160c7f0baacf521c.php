    ...
    <div class="panel-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="table1">
                ...
                <tr>
                    <td>
                        <div class="ckbox ckbox-primary"><input type="checkbox" id="checkbox<?php echo $vo['id']; ?>" name="checkid[]" value="<?php echo $vo['id']; ?>"/>
                            <label for="checkbox<?php echo $vo['id']; ?>"><?php echo $vo['id']; ?></label></div>
                    </td>
                    <td><?php echo $vo['title']; ?></td>
                    <td><?php echo show_img($vo['picurl'],$vo['picurl']); ?></td>
                    <td>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_32308__=1;$__FOR_END_32308__=9;for($i=$__FOR_START_32308__;$i < $__FOR_END_32308__;$i+=1){ ?>
