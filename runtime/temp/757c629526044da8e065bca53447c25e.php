<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\project\create.html";i:1556095194;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\create.html";i:1554692404;s:90:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\sidebar.html";i:1540438922;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\topbar.html";i:1540438923;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\footer.html";i:1554692403;}*/ ?>
<!DOCTYPE html>
...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="手机号" name="mobile" value="<?php echo isset($vo['mobile']) ? $vo['mobile'] :  ''; ?>" readonly required>
            </div>
        </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">套餐内容：</label>
                <div class="col-sm-6">
                    <?php if(is_array($vo['content']) || $vo['content'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?>
                    <input type="text" class="form-control1" name="con[]" placeholder="套餐内容"  value="<?php echo isset($co['con']) ? $co['con'] :  ''; ?>" readonly>
                    ...
                    <input type="hidden" class="but" name="pid[]" value="<?php echo isset($co['pid']) ? $co['pid'] :  ''; ?>">              <button type="button" class="jian" attr="<?php echo isset($co['pid']) ? $co['pid'] :  ''; ?>">-</button>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
        <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_20858__=1;$__FOR_END_20858__=9;for($i=$__FOR_START_20858__;$i < $__FOR_END_20858__;$i+=1){ ?>
