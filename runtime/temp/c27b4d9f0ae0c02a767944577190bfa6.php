<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:94:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\store_project\create.html";i:1556006845;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\create.html";i:1554692404;s:90:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\sidebar.html";i:1540438922;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\topbar.html";i:1540438923;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\footer.html";i:1554692403;}*/ ?>
<!DOCTYPE html>
...
<div class="panel panel-default">
        ...
        <div class="form-group">
              ...
              <div class="col-sm-6">
                  <input type="text" class="form-control" name="title" placeholder="项目名称"  required value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>">
              </div>
          </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="项目价格" name="price" value="<?php echo isset($vo['price']) ? $vo['price'] :  ''; ?>"  required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="总价值金额" name="old_price" value="<?php echo isset($vo['old_price']) ? $vo['old_price'] :  ''; ?>"  >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6 wh-inline">
                <div class="rdio rdio-primary">
                    <input type="radio" name="type" id="status-0" value="0" <?php if(\think\Request::instance()->action() == 'create'): ?> checked <?php endif; if(!(empty($vo) || ($vo instanceof \think\Collection && $vo->isEmpty()))): if($vo['type'] != '优惠项目'): ?> checked <?php endif; endif; ?>>
                    <label for="status-0">普通</label>
                </div>
                <div class="rdio rdio-primary">
                    <input type="radio" name="type" id="status-1" value="1" <?php if(!(empty($vo) || ($vo instanceof \think\Collection && $vo->isEmpty()))): if($vo['type'] == '优惠项目'): ?> checked <?php endif; endif; ?>>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_18995__=1;$__FOR_END_18995__=9;for($i=$__FOR_START_18995__;$i < $__FOR_END_18995__;$i+=1){ ?>
