...
<script>
    ...
    function ttk(id) {
        $.post(
            "<?php echo url('Deliver/achieve'); ?>", {id: id}, function (data) {
                layer.msg(data.msg);
                setTimeout(function () {
                    location.reload();
                }, 1000);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_25943__=1;$__FOR_END_25943__=9;for($i=$__FOR_START_25943__;$i < $__FOR_END_25943__;$i+=1){ ?>
