<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:91:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\agent_list\create.html";i:1554688910;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\create.html";i:1554692404;s:90:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\sidebar.html";i:1540438922;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\topbar.html";i:1540438923;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\footer.html";i:1554692403;}*/ ?>
<!DOCTYPE html>
        ...
        <form class="form-horizontal form-bordered" id="submitForm" action="" method="post">
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-6">-->
                    <!--<input type="text" class="form-control" name="account" placeholder="账号"-->
                           <!--value="<?php echo isset($vo['account']) ? $vo['account'] :  ''; ?>" readonly>-->
                <!--</div>-->
            <!--</div>-->
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-6">-->
                    ...
                    <!--<input type="hidden" id="picurl" name="picurl" value="<?php echo isset($vo['picurl']) ? $vo['picurl'] :  ''; ?>" required>-->
                <!--</div>-->
            <!--</div>-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="username" placeholder="请输入用户名" value="<?php echo isset($vo['username']) ? $vo['username'] :  ''; ?>" disabled  >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="手机号" name="mobile" value="<?php echo isset($vo['mobile']) ? $vo['mobile'] :  ''; ?>" disabled >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="control-label"> <?php echo $vo['update_time']; ?></label>
                </div>
            </div>
            <?php endif; ?>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_27727__=1;$__FOR_END_27727__=9;for($i=$__FOR_START_27727__;$i < $__FOR_END_27727__;$i+=1){ ?>
