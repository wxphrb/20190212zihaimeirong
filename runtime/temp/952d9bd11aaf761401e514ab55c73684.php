<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\agent\index.html";i:1554348002;s:87:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\base.html";i:1540438923;s:90:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\sidebar.html";i:1540438922;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\topbar.html";i:1540438923;s:89:"D:\phpstudy\WWW\20190213zihaimeirong\public/../application/shop\view\template\footer.html";i:1554692403;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
         <style>  .panel-stat h1 {    font-size: 20px;  }</style>      <div class="row">        <div class="col-sm-6 col-md-3">          <div class="panel panel-success panel-stat">            <div class="panel-heading">              <div class="stat">                <div class="row">                  <div class="col-xs-4">                    <img src="__CONSOLE__/images/is-user.png" alt="" />                  </div>                  <div class="col-xs-8">                    <small class="stat-label"></small>                    <h1>共享天使数量</h1>                  </div>                </div><!-- row -->                <div class="mb15"></div>                <div class="row">                  <div class="col-xs-6">                    <small class="stat-label">当日新增数量</small>                    <h4><?php echo isset($par['level_one_num']) ? $par['level_one_num'] :  0; ?></h4>                  </div>                  <div class="col-xs-6">                    <small class="stat-label">总数量</small>                    <h4><?php echo isset($par['level_one_num_all']) ? $par['level_one_num_all'] :  0; ?></h4>                  </div>                </div><!-- row -->              </div><!-- stat -->            </div><!-- panel-heading -->          </div><!-- panel -->        </div><!-- col-sm-6 -->        <div class="col-sm-6 col-md-3">          <div class="panel panel-danger panel-stat">            <div class="panel-heading">              <div class="stat">                <div class="row">                  <div class="col-xs-4">                    <img src="__CONSOLE__/images/is-user.png" alt="" />                  </div>                  <div class="col-xs-8">                    <small class="stat-label"></small>                    <h1>共享店主数量</h1>                  </div>                </div><!-- row -->                <div class="mb15"></div>                <div class="row">                  <div class="col-xs-6">                    <small class="stat-label">当日新增数量</small>                    <h4><?php echo isset($par['level_two_num']) ? $par['level_two_num'] :  0; ?></h4>                  </div>                  <div class="col-xs-6">                    <small class="stat-label">总数量</small>                    <h4><?php echo isset($par['level_two_num_all']) ? $par['level_two_num_all'] :  0; ?></h4>                  </div>                </div><!-- row -->              </div><!-- stat -->            </div><!-- panel-heading -->          </div><!-- panel -->        </div><!-- col-sm-6 -->        <div class="col-sm-6 col-md-3">          <div class="panel panel-primary panel-stat">            <div class="panel-heading">              <div class="stat">                <div class="row">                  <div class="col-xs-4">                    <img src="__CONSOLE__/images/is-user.png" alt="" />                  </div>                  <div class="col-xs-8">                    <small class="stat-label"></small>                    <h1>城市合伙人数量</h1>                  </div>                </div><!-- row -->                <div class="mb15"></div>                <div class="row">                  <div class="col-xs-6">                    <small class="stat-label">当日新增数量</small>                    <h4><?php echo isset($par['level_three_num']) ? $par['level_three_num'] :  0; ?></h4>                  </div>                  <div class="col-xs-6">                    <small class="stat-label">总数量</small>                    <h4><?php echo isset($par['level_three_num_all']) ? $par['level_three_num_all'] :  0; ?></h4>                  </div>                </div><!-- row -->                <!--                <small class="stat-label">% Bounce Rate</small>                <h4>34.23%</h4>                -->              </div><!-- stat -->            </div><!-- panel-heading -->          </div><!-- panel -->        </div><!-- col-sm-6 -->        <div class="col-sm-6 col-md-3">          <div class="panel panel-dark panel-stat">            <div class="panel-heading">              <div class="stat">                <div class="row">                  <div class="col-xs-4">                    <img src="__CONSOLE__/images/is-user.png" alt="" />                  </div>                  <div class="col-xs-8">                    <small class="stat-label"></small>                    <h1>联合创始人数量</h1>                  </div>                </div>                <div class="mb15"></div>                <div class="row">                  <div class="col-xs-6">                    <small class="stat-label">当日新增数量</small>                    <h4><?php echo isset($par['level_four_num']) ? $par['level_four_num'] :  0; ?></h4>                  </div>                  <div class="col-xs-6">                    <small class="stat-label">总数量</small>                    <h4><?php echo isset($par['level_four_num_all']) ? $par['level_four_num_all'] :  0; ?></h4>                  </div>                </div><!-- row -->                <!--                <div class="row">                  <div class="col-xs-6">                    <small class="stat-label">Last Week</small>                    <h4>$32,322</h4>                  </div>                  <div class="col-xs-6">                    <small class="stat-label">Last Month</small>                    <h4>$503,000</h4>                  </div>                </div>                -->              </div>            </div>          </div>        </div>      </div><!-- row --><div class="col-sm-6 col-md-3" style="padding-left:0px;padding-right:15px;">  <div class="panel panel-primary panel-stat">    <div class="panel-heading">      <div class="stat">        <div class="row">          <div class="col-xs-4">            <img src="__CONSOLE__/images/is-user.png" alt="" />          </div>          <div class="col-xs-8">            <small class="stat-label"></small>            <h1>会员卡数量</h1>          </div>        </div><!-- row -->        <div class="mb15"></div>        <div class="row">          <div class="col-xs-6">            <small class="stat-label">当日新增银卡数量</small>            <h4><?php echo isset($par['day_member_yin']) ? $par['day_member_yin'] :  0; ?></h4>          </div>          <div class="col-xs-6">            <small class="stat-label">总数量</small>            <h4><?php echo isset($par['all_member_yin']) ? $par['all_member_yin'] :  0; ?></h4>          </div>        </div><!-- row -->        <div class="row">          <div class="col-xs-6">            <small class="stat-label">当日新增金卡数量</small>            <h4><?php echo isset($par['day_member_jin']) ? $par['day_member_jin'] :  0; ?></h4>          </div>          <div class="col-xs-6">            <small class="stat-label">总数量</small>            <h4><?php echo isset($par['all_member_jin']) ? $par['all_member_jin'] :  0; ?></h4>          </div>        </div><!-- row -->        <div class="row">          <div class="col-xs-6">            <small class="stat-label">当日新增钻石卡数量</small>            <h4><?php echo isset($par['day_member_zuan']) ? $par['day_member_zuan'] :  0; ?></h4>          </div>          <div class="col-xs-6">            <small class="stat-label">总数量</small>            <h4><?php echo isset($par['all_member_zuan']) ? $par['all_member_zuan'] :  0; ?></h4>          </div>        </div><!-- row -->        <!--        <small class="stat-label">% Bounce Rate</small>        <h4>34.23%</h4>        -->      </div><!-- stat -->    </div><!-- panel-heading -->  </div><!-- panel --></div>      <!--<div class="row">-->        <!--<div class="col-sm-12">-->          <!--<div class="panel panel-default">-->            <!--<div class="panel-body">-->              <!--<div class="row">-->               <!--&lt;!&ndash;http://tianqi.2345.com/plugin&ndash;&gt;-->               <!--&lt;!&ndash;显示五天 &ndash;&gt;<iframe allowtransparency="true" frameborder="0" width="100%" height="98" scrolling="no" src="http://tianqi.2345.com/plugin/widget/index.htm?s=2&z=1&t=1&v=0&d=5&bd=0&k=000000&f=0080ff&q=1&e=1&a=1&c=50953&w=100%&align=left"></iframe>-->              <!--</div>-->              <!--&lt;!&ndash; row &ndash;&gt;-->            <!--</div>&lt;!&ndash; panel-body &ndash;&gt;-->          <!--</div>&lt;!&ndash; panel &ndash;&gt;-->        <!--</div>&lt;!&ndash; col-sm-9 &ndash;&gt;-->      <!--</div>&lt;!&ndash; row &ndash;&gt;-->
    </div><!-- contentpanel -->
  </div><!-- mainpanel -->
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_29854__=1;$__FOR_END_29854__=9;for($i=$__FOR_START_29854__;$i < $__FOR_END_29854__;$i+=1){ ?>
